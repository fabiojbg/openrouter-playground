...
export default function ChatPlaceholder(_a) {
    return (<div className="flex h-full w-full items-center justify-center">
      <div className="max-w-3xl p-4 text-center text-primary">
        <h1 className="text-4xl font-medium">DeepSeek Playground</h1>
        <p className="mt-4 text-lg">
          A DeepSeekGPT built with React, Next.js, TailwindCSS, and DeepSeek
          that allows you to play with your DeepSeekChat api key early!
        </p>
